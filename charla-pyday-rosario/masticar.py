...
print "Porcentaje de ocupacion en no FLOSS: %f.2" % ((100.*c_ocup_no_floss)/c_no_floss)

c_ocup_floss = len([x for x in resultados if x.ocupado and x.floss])
print "Porcentaje de ocupacion en FLOSS: %f.2" % ((100.*c_ocup_floss)/c_floss)

c_ocup_lider = len([x for x in resultados if x.ocupado and x.floss_leader])
print "Porcentaje de ocupacion en lideres FLOSS: %f.2" % ((100.*c_ocup_lider)/c_lider)
...
print "Eso no tiene sentido, pibe."
print "Asi es la estadistica."


print "Esa estadistica anterior es medio mentira"
